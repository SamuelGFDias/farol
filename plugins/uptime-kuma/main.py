#!/usr/bin/env python3
"""Plugin de referência `uptime-kuma` — o lado "servidor" do protocolo Farol v0.5.
...
issue #9): `widget/get` passa a devolver o campo `kind` (aqui sempre `"Monitor"`) no envelope de
...
# variante `WidgetItems::Monitor` do lado Rust (`crates/farol-protocol/src/messages.rs`).
WIDGET_ITEMS_KIND = "Monitor"
