...
# --- Verificação 4: encerra ao receber SIGTERM ------------------------------
...
# --- Verificação 5: nenhum processo remanescente ----------------------------
...
log "SUCESSO — 5/5 condições confirmadas em ${ELAPSED}s (teto do cenário: ${SCENARIO_TIMEOUT_SECONDS}s)"
